...
class GameScene {
  ...
  spawnRandomObstacle () {
    ...
    if (randomNumber < 0.25) {
        this.box = BABYLON.Mesh.CreateBox("Box1", 1.5, 0, this.gameScene);
        const material1 = new BABYLON.StandardMaterial("material1", this.gameScene);
      ...
      this.box = BABYLON.Mesh.CreateBox("Box2", 1.5, 0, this.gameScene);
        const material2 = new BABYLON.StandardMaterial("material1", this.gameScene);
        ...
        this.box = BABYLON.Mesh.CreateBox("Box3", 1, 0, this.gameScene);
        const material3 = new BABYLON.StandardMaterial("material1", this.gameScene);
      ...
      this.box = BABYLON.Mesh.CreateBox("Box4", .5, 0, this.gameScene);
        const material4 = new BABYLON.StandardMaterial("material1", this.gameScene);
